        ...
        <div class="site-header">
				...
				promoting research, education, and software development activities towards
    ...
    <!-- Latest News -->
        ...
        <hr class="d-sm-none" />
        <h2>Latest News</h2>
        <em class="d-md-none">(scroll on news body to read more news)</em>
			...
			<div class="col-md-4">
				<div class="home-card card">
				  <h5 class="home-card-title card-title">Our Research</h5>
					<div class="home-card-body card-body">
						<p class="card-text">We are involved in a range of projects addressing fundamental questions in artificial intelligence, human-computer interaction, and data science, as well as in applied interdisciplinary research.</p>
    ...
    <!-- Desktop/Tablet layout -->
		...
		<div class="home-section row flex-md-row">
			<div class="col-md-4">
				<img src="images/our_expertise.svg" alt="Graphic on our expertise" />
			</div>
			<div class="col-md-8">
